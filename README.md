...
The closure rate of food service businesses pre-COVID, otherwise known as the industry "churn" rate, was 30% annually. With 53% of businesses receiving funding closing over 2 years, this shows an average closure rate of 26% annually, 4% below the average churn rate. This is signifact reduction in churn rate considering projections put closures due to COVID exceeding the industry average by a large margin.  This is the measurable impact the PPP funding program had on businesses - incrased their resiliency during 2020 and 2021 against the effects of COVID. The strongest predictor was Approval Date, so business that were able to receive funding in the first round, and most importantly before April 2021 were most likely to remain open. 
